...
extract(adminNavLinkResolve(get_defined_vars(), [
    'href' => 'upload_manage.php?section=overview',
    'label' => '视频上传',
]), EXTR_OVERWRITE);
